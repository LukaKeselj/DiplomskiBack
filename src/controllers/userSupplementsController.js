...
export function createUserSupplementsController({ userSupplementService }){
    async function getAllUserSupplements(req,res){
        try{
    ...
    async function getUserSupplement(req,res){
        try{
    ...
    async function createUserSupplement(req,res){
        try{
    ...
    async function deleteUserSupplement(req,res){
        try{
    ...
    return { getAllUserSupplements, getUserSupplement, createUserSupplement, updateUserSupplement, deleteUserSupplement };
}
