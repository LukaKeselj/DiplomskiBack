...
export async function getAllUserSupplements(userId){
    return userSupplementRepository.findAllByUser(userId);
}

export async function getUserSupplementById(id, requesterId, requesterRole){
    assertValidId(id);
...
export async function createUserSupplement(userId, {supplement, dosage, timeOfDay, active}){
    if(!dosage){
...
export async function updateUserSupplement(id, requesterId, requesterRole, {supplement, dosage, timeOfDay, active}){
    assertValidId(id);
...
export async function deleteUserSupplement(id, requesterId, requesterRole){
    assertValidId(id);
