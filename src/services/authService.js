...
export function createAuthService({ userRepository, refreshTokenRepository, mailService, auditLogService }){
    ...
    async function completeGoogleRegistration(pendingToken, {username, height}){
        let decoded;
        try{
