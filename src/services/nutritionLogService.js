...
export function createNutritionLogService({ nutritionLogRepository }){
    ...
    async function createLog(userId, {date, foodName, foodId, calories, protein, fat, carbs, fiber}){
        if(!foodName){
    ...
    async function updateLog(id, requesterId, requesterRole, data){
        assertValidId(id);
